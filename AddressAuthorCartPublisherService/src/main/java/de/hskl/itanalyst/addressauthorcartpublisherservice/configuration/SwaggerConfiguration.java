package de.hskl.itanalyst.addressauthorcartpublisherservice.configuration;
...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build()
                .ignoredParameterTypes(AddressEntity.class, AuthorEntity.class, CartEntity.class, PublisherEntity.class)
